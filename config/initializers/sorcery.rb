...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.facebook.key = "1037358049626791"
  config.facebook.secret = "c2232104a9eb84761c79b7377bdc0de6"
  config.facebook.callback_url = "http://storyhoot.com/oauth/callback?provider=facebook"
